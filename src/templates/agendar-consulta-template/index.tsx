...
const AgendarConsultaTemplate = ({ idHorario }: AgendarConsultaTemplateProps) => {
    ...
    function confirmarAgendamento(){
        alert("confirmando");
        route.push("/pagamento/consulta/9b7f7f6e-86de-4f2b-b701-34a05c5ba89e")
    }
            ...
            <div className={styles.container}>
                <div className={styles.container_medico}>
                    <div className={styles.informacoes}>
                        <div>
                            <img src="https://avatars.githubusercontent.com/u/88343716?v=4" alt="foto" />
                        </div>
                ...
                <div className={styles.container_endereco}>
                    <BoardComLabels title='Dados do endereço de atendimento'>
                        ...
                        <LabelTitleTop title='Complemento'>Proximo a clinica tals</LabelTitleTop>
                    </BoardComLabels>
                    <BoardComLabels title='Confirmação do agendamento'>
                        <div className={styles.container_confirm_mensagem}>
                            <div className={styles.horario_disponiveis}>
                                ...
                                <LabelTitleLeft title='Entre:'>10:00 <strong>e</strong> 12:00 <span className={styles.informativo}>(Médico pode inserir mais detalhes do horário)</span></LabelTitleLeft>
                                <LabelTitleLeft title='Valor Consulta'>R$ 200,00</LabelTitleLeft>
                            </div>
                            <div className={styles.acoes_disponiveis}>
                                <Button key="sdsds" childrenColor="rgb(255, 255, 255)" color="rgb(29, 66, 230)" onClick={e => confirmarAgendamento()}>Confirmar</Button>
                                <Button key="sdsds" childrenColor="rgb(255, 255, 255)" color="rgb(230, 29, 29)" onClick={e => cancelarAgendamento()}>Cancelar</Button>
                            </div>
                        </div>
                    </BoardComLabels>   
                </div>
...
export default AgendarConsultaTemplate;