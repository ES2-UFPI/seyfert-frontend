                    ...
                    <BoardComLabels title='Confirmação do agendamento'>
                        <div className={styles.container_confirm_mensagem}>
                            ...
                            <div className={styles.acoes_disponiveis}>
                                <ButtonComponent key="sdsds" childrenColor="rgb(255, 255, 255)" color="rgb(29, 66, 230)" onClick={confirmarAgendamento}>Confirmar</ButtonComponent>
                                <ButtonComponent key="sdsds" childrenColor="rgb(255, 255, 255)" color="rgb(230, 29, 29)" onClick={cancelarAgendamento}>Cancelar</ButtonComponent>
                            </div>
                        </div>
                    </BoardComLabels>   
                </div>
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    const id = ctx.query?.uuidHorario
    return {
        props: {
            idHorario: id
        }
